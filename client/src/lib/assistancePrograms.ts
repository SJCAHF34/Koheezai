...
export const drugAssistanceData: DrugAssistanceEntry[] = [
    ...
    programs: [
      {
        name: "Gilead Advancing Access® Co-pay Savings",
        type: "copay",
        description: "Copay assistance for commercially insured patients prescribed Descovy for HIV treatment or PrEP (Pre-Exposure Prophylaxis). Patients may pay as little as $0/month.",
        eligibility: "Commercial/private insurance only. Not valid for Medicare, Medicaid, TRICARE, or VA.",
      ...
      },
      {
        name: "Gilead Advancing Access® Patient Assistance (PAP)",
        type: "pap",
        description: "Free Descovy for uninsured or underinsured patients meeting income criteria. Covers both HIV treatment and PrEP indications.",
  ...
  {
    brandName: "Apretude",
    genericName: "Cabotegravir Extended-Release Injectable Suspension",
    drugIds: ["apretude", "cabotegravir_prep"],
    manufacturer: "ViiV Healthcare",
    programs: [
      {
        name: "ViiVConnect Copay Assistance – Apretude",
        type: "copay",
        description: "Copay support for commercially insured patients receiving Apretude (cabotegravir LA), the long-acting injectable PrEP given every 2 months after two initiation injections. Patients may pay as little as $0 per injection.",
        eligibility: "Commercial/private insurance only. Not valid for Medicare, Medicaid, TRICARE, or other government programs.",
        savings: "Up to $9,600/year",
        phone: "1-844-588-3288",
        website: "https://www.apretude.com/support",
        needymedsUrl: "https://www.needymeds.org/drug_list.taf?_function=name&name=Apretude",
      },
      {
        name: "GSK Patient Assistance Program (PAP) – Apretude",
        type: "pap",
        description: "Free Apretude (cabotegravir LA) for uninsured or underinsured patients who meet program requirements. Covers both initiation and maintenance injections.",
        eligibility: "Uninsured or underinsured US residents. Income requirements apply.",
        savings: "Free medication",
        phone: "1-844-588-3288",
        website: "https://gskpaf.org/viiv/prescription-medicine-patient-assistance/apretude/",
        needymedsUrl: "https://www.needymeds.org/drug_list.taf?_function=name&name=Apretude",
      },
    ],
  },
    ...
    programs: [
      {
        ...
        savings: "Up to $6,800/year",
        phone: "1-855-834-3467",
        website: "https://www.merckhelps.com/DELSTRIGO",
    ...
    programs: [
      {
        ...
        savings: "Up to $6,800/year",
        phone: "1-855-834-3467",
        website: "https://www.merckhelps.com/PIFELTRO",
  ...
  {
    brandName: "Yeztugo",
    genericName: "Emtricitabine/Tenofovir Alafenamide (Generic PrEP)",
    drugIds: ["yeztugo", "ftc_taf_generic"],
    manufacturer: "Sandoz",
    programs: [
      {
        name: "Sandoz US Copay Savings Card – Yeztugo",
        type: "copay",
        description: "Sandoz offers a copay savings card for commercially insured patients taking Yeztugo, the first FDA-approved generic oral PrEP (emtricitabine/tenofovir alafenamide). Patients may pay significantly less out-of-pocket than with the brand.",
        eligibility: "Commercially insured patients. Not valid for Medicare, Medicaid, or other federal/state programs.",
        phone: "1-800-525-8747",
        website: "https://www.sandozus.com/en/patients/patient-savings-programs.html",
        needymedsUrl: "https://www.needymeds.org/drug_list.taf?_function=name&name=Yeztugo",
      },
      {
        name: "NeedyMeds – Yeztugo Assistance Programs",
        type: "pap",
        description: "NeedyMeds lists available patient assistance programs for Yeztugo. As a generic, the cost is substantially lower than the brand, and additional programs may be available for uninsured patients.",
        eligibility: "Uninsured or underinsured. Varies by program.",
        website: "https://www.needymeds.org/drug_list.taf?_function=name&name=Yeztugo",
        needymedsUrl: "https://www.needymeds.org/drug_list.taf?_function=name&name=Yeztugo",
      },
    ],
  },
