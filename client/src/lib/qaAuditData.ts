...
// (Accreditation Ready Review). 7 sections, 189 items.
// Source: attached_assets/Pharmacy_Questions_Answers_*.pdf
...
export const QA_AUDIT_SECTIONS: QaAuditSection[] = [
  {
    ...
    items: [
      ...
      { id: "core-2", title: `The pharmacy staff knows how to access and use the Quantros reporting system.` },
      { id: "core-3", title: `The pharmacy staff is familiar with the AHF Customer Care Line and how patients can access.` },
      ...
      { id: "core-10", title: `The pharmacy has a secure "bin" for the collection of protected patient information (HIPAA).` },
      ...
      { id: "core-24", title: `The pharmacy staff has access to the AHF Employee Handbook.` },
      ...
      { id: "core-27", title: `The pharmacy staff can describe the AHF Pharmacy chain of command.` },
      { id: "core-28", title: `The pharmacy staff is knowledgeable in how to access on-line drug information (Gold Standard software).` },
      { id: "core-29", title: `All AHF Pharmacist have completed the National Certification for HIV medicine (AAHIVP) through the American Association of HIV Medicine or are working to be certified. (List name and dates of application if not certified in plan of correction.)` },
      ...
      { id: "core-33", title: `Are required state and federal labor law posters visible to employees?` },
      ...
      { id: "core-45", title: `There is evidence that the Pharmacy Staff can print a Patient Medication Leaflet at the request of a patient for new or refill prescriptions.` },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "cust-9", title: `The Pharmacy staff is aware of how to access the language line and the instructions are posted within the pharmacy work area in a place that all have easy access.` },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "ops-2", title: `The staff has access to the employee handbook.` },
      ...
      { id: "ops-6", title: `The staff can access reference materials including clinical, policy and procedures.` },
      ...
      { id: "ops-10", title: `The auditor observes the packing of all delivery/shipping packages contain temperature appropriate devices to maintain appropriate temperature of medications during delivery/shipping.` },
      ...
      { id: "ops-15", title: `Is there evidence that if a shipping/delivery is delayed or lost, that the pharmacy staff refills the medications and ships/delivers the patient's medications to the patient by the most expedient method to help ensure the patient does not miss doses.` },
      ...
      { id: "ops-18", title: `The pharmacy maintains a daily temperature log for the medication refrigerator, and entries are current.` },
      { id: "ops-19", title: `The pharmacy has implemented AHF approved procedures for routinely checking inventory for expired medications.` },
      { id: "ops-20", title: `The pharmacy has established a clearly marked separate storage area for hazardous materials.` },
      { id: "ops-21", title: `The pharmacy has established a clearly marked separate storage area for medications that are expired and/or otherwise not suitable for dispensing to patients.` },
      { id: "ops-22", title: `Staff is familiar with Universal Precautions.` },
      { id: "ops-23", title: `Staff is familiar with the location of the "Spill Kit".` },
      { id: "ops-24", title: `Staff is familiar with the "Eye Wash" station.` },
      { id: "ops-25", title: `Staff is familiar with Emergency Preparedness procedures.` },
      { id: "ops-26", title: `The pharmacy has implemented a system of routinely cleaning all equipment utilized in the fulfillment of prescriptions, including counting devices, automated dispensing equipment, weighing balances and other dispensing devices. The log for maintenance of equipment calibration is current.` },
      ...
      { id: "ops-34", title: `The pharmacy staff is familiar with accessing Material Safety Data Sheets (MSDS).` },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "pat-6", title: `Staff is aware of the AHF records retention policy.` },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "dme-11", title: `The location was able to show the copy of the supplier standards.` },
      ...
      { id: "dme-15", title: `The location was able to show the Accreditation information.` },
    ],
  },
];
