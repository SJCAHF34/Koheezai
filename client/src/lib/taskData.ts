...
export const TASKS: PharmacyTask[] = [
  ...
  {
    id: "rph1-d-003",
    title: "Scan order grouping to release orders",
  ...
  {
    id: "rph1-d-008",
    title: "Designated RPh for PV1 P4H scripts",
    description: "Complete PV1 pharmacist verification for P4H prescriptions as designated RPh.",
    role: "pharmacist_1",
    frequency: "daily",
    category: "operations",
    taskGroup: "PV1 / P4H",
  ...
  },
  {
    ...
    description: "Complete pharmacist consultations for new PIKE prescriptions and non-waiter patients.",
    role: "pharmacist_1",
    frequency: "daily",
    category: "operations",
    taskGroup: "PV1 / P4H",
  ...
  {
    id: "rph2-d-005",
    title: "Designated RPh for PV1 PIKE scripts",
  ...
  {
    id: "rph2-d-007",
    title: "P4H new consults in PIKE queue",
    description: "Complete pharmacist consultations for new P4H patients in the PIKE queue.",
    role: "pharmacist_2",
    frequency: "daily",
    category: "operations",
    taskGroup: "PIKE PV1",
  ...
  {
    id: "rph2-d-008",
    title: "PIKE RPh review chat issues (DUR rejects, Rx clarification, therapy duplication)",
    description: "Address DUR rejects, Rx clarification, and therapy duplication issues in PIKE RPh review chat.",
    role: "pharmacist_2",
    frequency: "daily",
    category: "operations",
    taskGroup: "PIKE PV1",
  ...
  {
    id: "rph2-d-009",
    title: "Kevin Romero referrals",
    description: "Process and follow up on patient referrals from Kevin Romero.",
    role: "pharmacist_2",
    frequency: "daily",
    category: "operations",
    taskGroup: "PIKE PV1",
  ...
  {
    id: "rph2-d-010",
    title: "Resolve audit emails (if any)",
    description: "Review and resolve any outstanding audit-related emails.",
    role: "pharmacist_2",
    frequency: "daily",
    category: "operations",
    taskGroup: "PIKE PV1",
